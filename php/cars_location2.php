  ...
  <nav class="navbar navbar-inverse">
	...
	<div class="container">
		...
		if ($tabelle->connect_error) {
		 ...
		 $sql = "SELECT carId, carImage, carModel, cost, adress, city, zipCode FROM cars LEFT JOIN location ON cars.fk_locationId = location.locationId WHERE zipCode=1010";
